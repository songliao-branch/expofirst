...
const UserBar = (props)=> {
  return (
    <View style={{flex:1, flexDirection: 'row', justifyContent:'space-between', paddingBottom:50}}> 
      <View>
        <Text style={{color:'rgba(71,83,89,1)', fontSize:15, fontWeight:'600'}}>Wecome Back</Text>
        <Text style={{color:'rgba(71,83,89,1)', fontSize:30, fontWeight:'600'}}>{props.username}</Text>
      </View>
